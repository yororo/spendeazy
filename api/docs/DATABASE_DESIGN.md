...
| `transactions` | Space-owned positive expenses with optional Category and Committed Statement Import relationships. `added_by_user_id` preserves actor attribution; nullable `deleted_at` retains deleted rows outside active spending. |
