...
export class CategoryRulesController {
  ...
  async createCategoryRule(
    ...
    const rule = await this.categoryRulesService.createCategoryRule(
  ...
  async listCategoryRules(
    ...
    const rules = await this.categoryRulesService.listCategoryRules(
      requireAuthenticatedUserId(request),
    );
  ...
  async deleteCategoryRule(
    ...
    await this.categoryRulesService.deleteCategoryRule(
      requireAuthenticatedUserId(request),
      params.ruleId,
    );
  }
