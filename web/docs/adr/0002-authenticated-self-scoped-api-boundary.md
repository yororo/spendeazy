...
The accepted target design in [Personal and Shared Spaces](../../../docs/adr/0002-personal-and-shared-spaces.md) extends financial ownership to authorized Spaces while retaining independent sign-in identities and centralized authentication. Implementation is pending; the paragraph below records the original User-scoped boundary.
